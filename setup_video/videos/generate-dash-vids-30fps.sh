...
ffmpeg -i dubai.mkv -map 0:v:0  -map 0:v:0 -map 0:v:0 -map 0:v:0 -map 0:v:0 -map 0:v:0 \
...
-init_seg_name 'dubai_30fps/$RepresentationID$/init-stream.mp4' \
-media_seg_name 'dubai_30fps/$RepresentationID$/$Number%05d$.m4s' \
