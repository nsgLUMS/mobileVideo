! function a(b, c, d) {
        ...
        function d(a, b, c) {
            ...
            function h(f) {
                if (f.nodeType == u.DOCUMENT_NODE) {
                    ...
                    for (j = 0, k = f.childNodes.length; j < k; j += 1)
            ...
            function n(a) {
                var b = [];
                if (a instanceof Object)
                    for (var c in a) c.toString().indexOf("__") == -1 && 0 == c.toString().indexOf("_") && b.push(c);
                return b
            }
    ...
    16: [function (a, b, c) {
        ...
        function e(a) {
            ...
            function y(a) {
                var b, c, d, e = a.adaptation.period,
                    f = a.segmentInfoType,
                    g = !1;
            ...
            function A(a, b) {
                if (a.segments = b, b && b.length > 0 && (Z = isNaN(Z) ? b[0].presentationStartTime : Math.min(b[0].presentationStartTime, Z)), W && isNaN(P.getExpectedLiveEdge())) {
                    var c = b.length - 1,
                        d = b[c],
                        e = d.presentationStartTime,
                        f = R.getMetricsFor("stream");
                    P.setExpectedLiveEdge(e), R.updateManifestUpdateInfo(Q.getCurrentManifestUpdate(f), {
            ...
            function C(a, b) {
                ...
                return a.segmentDuration || a.segments || B(a), a.segmentAvailabilityRange = null, a.segmentAvailabilityRange = P.calcSegmentAvailabilityRange(a, W), a.segmentAvailabilityRange.end < a.segmentAvailabilityRange.start && !a.useCalculatedLiveEdgeTime ? (c = new i.default(x, "no segments are available yet", {
                    availabilityDelay: a.segmentAvailabilityRange.start - a.segmentAvailabilityRange.end
                }), void M.trigger(l.default.REPRESENTATION_UPDATED, {
                    sender: this,
                    representation: a,
                    error: c
            ...
            function I(a) {
                ...
                b.segments && M.trigger(l.default.REPRESENTATION_UPDATED, {
                    sender: this,
                    representation: b
                })
            }
            ...
            var K = this.context,
                L = (0, r.default)(K).getInstance().log,
                M = (0, n.default)(K).getInstance(),
                N = (0, t.default)(K).getInstance(),
                O = a.segmentBaseLoader,
                P = a.timelineConverter,
                Q = a.dashMetrics,
                R = a.metricsModel,
                S = a.baseURLController,
                T = void 0,
                U = void 0,
                V = void 0,
                W = void 0,
        ...
        function e() {
            ...
            function c(a, b) {
                ...
                p("Start searching for initialization."), g.onload = function () {
                    g.status < 200 || g.status > 299 || (d = !1, k.bytesLoaded = k.range.end, f = v.parse(g.response), e = h(f), e ? (a.range = e, a.initialization = k.url, r.trigger(o.default.INITIALIZATION_LOADED, {
                        representation: a
                    })) : (k.range.end = k.bytesLoaded + k.bytesToLoad, c(a, k)))
                }, g.onloadend = g.onerror = function () {
                    d && (d = !1, u.downloadError("initialization", k.url, g), r.trigger(o.default.INITIALIZATION_LOADED, {
                        representation: a
                    }))
                    ...
                    if (!(o.status < 200 || o.status > 299)) {
                        ...
                        if (i = !1, r.bytesLoaded = r.range.end - r.range.start, k = v.parse(o.response), m = k.getBox("sidx"), m && m.isComplete) {
                            ...
                            if (null !== l && void 0 !== l && l.length > 0 && (h = 1 === l[0].reference_type), h) {
                                ...
                                var n, q, s, t, u, w = [],
                                    x = 0,
                                    y = (m.offset || r.range.start) + m.size,
                                    z = function (c) {
                            ...
                            if (m) r.range.start = m.offset || r.range.start, r.range.end = r.range.start + (m.size || c);
                            else {
    ...
    19: [function (a, b, c) {
        ...
        function e() {
            ...
            function h(a, b) {
                ...
                var i = function () {
                        a.initialization = h.url, t.trigger(g.default.INITIALIZATION_LOADED, {
                            representation: a
                        })
                    },
                    j = function () {
    ...
    21: [function (a, b, c) {
        ...
        function e() {
            ...
            function n(a, b, c) {
                var d, e, f = null,
                    g = U.getStreamInfo(),
                    h = V.getTopQualityIndexFor(c, g.id);
                if (R = !0, N.trigger(E.default.DATA_UPDATE_STARTED, {
                        sender: this
                    }), S = z(b), null === P && "fragmentedText" !== c ? (e = V.getAverageThroughput(c), f = e || V.getInitialBitrateFor(c, g), d = V.getQualityForBitrate(U.getMediaInfo(), f)) : d = V.getQualityFor(c, g), d > h && (d = h), T = t(d), P = a, "video" !== c && "audio" !== c && "fragmentedText" !== c) return R = !1, void N.trigger(E.default.DATA_UPDATE_COMPLETED, {
                    sender: this,
                    data: P,
            ...
            function F(a) {
                var b = a,
                    c = function () {
                        if (!h()) {
                            R = !0, N.trigger(E.default.DATA_UPDATE_STARTED, {
                                sender: O
                            }), D();
                            for (var a = 0; a < S.length; a++) W.updateRepresentation(S[a], !0)
                        }
                    };
                R = !1, N.trigger(E.default.AST_IN_FUTURE, {
                    delay: b
                }), setTimeout(c, b)
            }
            ...
            function G(a) {
                if (a.sender.getStreamProcessor() === U && h()) {
                    var b, c, d, e = a.representation,
                        f = $.getMetricsFor("stream"),
                        g = $.getMetricsFor(j().adaptation.type),
                        i = ca.getCurrentManifestUpdate(f),
                        k = !1,
                        l = 0;
                    ...
                    if (i) {
                        for (var o = 0; o < i.trackInfo.length; o++)
                            if (b = i.trackInfo[o], b.index === e.index && b.mediaType === U.getType()) {
                                k = !0;
                                break
                    ...
                    x() && (R = !1, V.setPlaybackQuality(U.getType(), U.getStreamInfo(), v(T)), $.updateManifestUpdateInfo(i, {
                        latency: T.segmentAvailabilityRange.end - Y.getTime()
                    }), d = ca.getCurrentRepresentationSwitch(g), d || p(), N.trigger(E.default.DATA_UPDATE_COMPLETED, {
                        sender: this,
                        data: P,
                        currentRepresentation: T
                    }))
            ...
            function I(a) {
                if (!a.error) {
                    ...
                    var b = Z.getValue(),
                        c = T.adaptation.period,
                        d = X.getActiveStreamInfo();
    ...
    22: [function (a, b, c) {
        ...
        function e() {
            ...
            function F(a, b, c, d) {
                ...
                if (e.length > 1 && d)
                    for (var f = la.getCurrentTrackFor(c, d), g = ma.getAllMediaInfoForType(a, d, c), h = 0, i = e.length; h < i; h++) {
            ...
            var ia = void 0,
                ja = this.context,
                ka = (0, q.default)(ja).getInstance(),
                la = (0, s.default)(ja).getInstance(),
                ma = (0, u.default)(ja).getInstance(),
    ...
    32: [function (a, b, c) {
        ...
        function e() {
            ...
            function b(a) {
                var b, c, d, f, g, h, i, j, k, l, m, n = e.parse(a),
                    o = n.getBox("tfhd"),
                    p = n.getBox("tfdt"),
                    q = n.getBox("trun"),
                    r = n.getBox("moof"),
                ...
                return m = g - p.baseMediaDecodeTime, {
                    sampleList: h,
                    sequenceNumber: l,
                    totalDuration: m
                }
    ...
    37: [function (a, b, c) {
        ...
        function e() {
            ...
            function p(a, b) {
                var c, d, e = a.adaptation.period.start,
                    f = e + a.adaptation.period.duration,
                    g = {
                        start: e,
                        end: f
                    },
                ...
                var i = isNaN(c) ? d : Math.min(c, d),
                    j = a.adaptation.period.start + a.adaptation.period.duration;
                return f = (i >= j && i - h < j ? j : i) - h, g = {
                    start: e,
                    end: f
                }
            }
    ...
    50: [function (a, b, c) {
        ...
        function e() {
            ...
            function j(a) {
                var b, c, d = new Date;
                z.setValue(a), r("Manifest has been refreshed at " + d + "[" + d.getTime() / 1e3 + "] "), b = A.getRefreshDelay(a), c = ((new Date).getTime() - a.loadedTime.getTime()) / 1e3, u = Math.max(b - c, 0), s.trigger(i.default.MANIFEST_UPDATED, {
                    manifest: a
                }), w || h()
            }
            ...
            var q = this.context,
                r = (0, m.default)(q).getInstance().log,
                s = (0, g.default)(q).getInstance(),
                t = void 0,
                u = void 0,
                v = void 0,
                w = void 0,
    ...
    51: [function (a, b, c) {
        ...
        function e() {
            ...
            function b(a, b, c) {
                return mc = (0, u.default)(Wb).getInstance(), lc = (0, s.default)(Wb).getInstance(), mc.supportsMediaSource() ? void(bc || (bc = !0, ec = (0, M.default)(Wb).getInstance(), pc = (0, i.default)(Wb).getInstance(), fc = (0, m.default)(Wb).getInstance(), fc.initialize(), rc = (0, pa.default)(Wb).getInstance(), qc = (0, ra.default)(Wb).getInstance(), jc = (0, K.default)(Wb).getInstance(), jc.setConfig({
                    adapter: Lb()
                }), fb(), qa(void 0 === c || c), a && Bb(a), b && Fb(b), Zb("[dash.js " + T() + "] MediaPlayer has been initialized"))) : void lc.capabilityError("mediasource")
            }
            ...
            function B(a) {
                ...
                if (void 0 !== a) b = nc.getTimeRelativeToStreamId(b, a);
                else if (pc.getIsDynamic()) {
                    var c = Ob();
            ...
            function Ib() {
                ...
                }), fc.initialize(), fc.setConfig({
                    errHandler: lc
                }), oc = (0, U.default)(Wb).getInstance(), oc.initialize(), oc.setConfig({
            ...
            function Lb() {
                return ic = (0, la.default)(Wb).getInstance(), ic.initialize(), ic.setConfig({
                    dashManifestModel: rc
                }), ic
            }
            ...
            function Mb() {
                ...
                if ("function" == typeof a) {
                    var b = a(Wb).create();
                    return ea.default.extend(a.events), ga.default.extend(a.events, {
                        publicOnly: !0
                    }), gc = b.createProtectionSystem({
                        log: Zb,
                        videoModel: sc,
                        capabilities: mc,
                        eventBus: Xb,
            ...
            var Sb = "You must first call play() to init playback before calling this method",
                ...
                Vb = "MediaPlayer not initialized!",
                Wb = this.context,
                Xb = (0, ca.default)(Wb).getInstance(),
                Yb = (0, aa.default)(Wb).getInstance(),
                Zb = Yb.log,
                $b = void 0,
                _b = void 0,
                ac = void 0,
    ...
    53: [function (a, b, c) {
        ...
        var g = a(51),
            h = d(g),
            i = e(),
            j = window && window.dashjs && window.dashjs.skipAutoCreate;
        ...
        function e() {
            function a(a, c) {
                ...
                if (R = d.getMediaInfoArr(), S.setConfig({
                        videoModel: Y
                    }), S.initialize(), T = !K.getIsTextTrack(a), H = (0, k.default)(C).getInstance(), Q = (0, i.default)(C).getInstance(), Q.setConfig({
                        boxParser: H
                    }), T) {
            ...
            function b() {
                aa = [], R = [], Y = (0, s.default)(C).getInstance(), S = (0, u.default)(C).getInstance(), S.setConfig({
                    videoModel: Y
                }), S.initialize(), H = (0, k.default)(C).getInstance(), Q = (0, i.default)(C).getInstance(), Q.setConfig({
                    boxParser: H
                }), T = !1, _ = null, ba = !1, ca = 0, fa = [], ea = [], da = null, E = !0
            }
            ...
            function c(a, b) {
                ...
                if ("fragmentedText" === l)
                    if (V)
                        if (i = Q.getSamplesInfo(a), f = i.sampleList, !$ && f.length > 0 && ($ = f[0].cts - b.start * W), n.search("stpp") >= 0)
                            for (N = null !== N ? N : B(n), h = 0; h < f.length; h++) {
                                var p = f[h],
                                    q = p.cts,
                                    r = q - $;
                    ...
                    if ("InitializationSegment" === b.segmentType) {
                        ...
                        if (!fa[0] && !fa[1]) {
                            ...
                            for (h = 0; h < aa.length; h++) {
                                ...
                                P = L(this, U), fa[h] = new y.default.Cea608Parser(h, {
                                    newCue: P
                                }, null)
                            }
                        }
            ...
            function d(a) {
                ...
                for (var h = d.offset + g.data_offset, i = g.sample_count, j = h, k = e.baseMediaDecodeTime, l = new DataView(a), m = {
                    ...
                    for (var p = g.samples[o], q = k + n + p.sample_composition_time_offset, r = y.default.findCea608Nalus(l, j, p.sample_size), s = 0; s < r.length; s++)
                        for (var t = y.default.extractCea608DataFromRange(l, r[s]), u = 0; u < 2; u++) t[u].length > 0 && b(m.fields[u], q, t[u]);
            ...
            var C = this.context,
                D = (0, q.default)(C).getInstance().log,
                E = !1,
                F = 0,
                G = void 0,
                H = void 0,
        ...
        function e() {
            ...
            function e(a, b, c) {
                var d = 0,
                    e = 0;
                if (Ga >= 1)
                    for (var f = Math.max(0, Ga + 1 - ya); f <= Ga - 1; f++) Ca[f] != Ca[f + 1] && (e += 1);
            ...
            function v(a) {
                ...
                if (!Pa.hasOwnProperty(a))
                    if (Qa.hasOwnProperty(a)) {
                        var c = Xa.getValue(),
                            d = Ya.getAdaptationForType(c, 0, a).Representation;
                        if (Array.isArray(d)) {
            ...
            function T(a, b, e, f) {
                var g = _a.getReadOnlyMetricsFor("video"),
                    h = $a.getCurrentHttpRequest(g),
                    i = l(b, e, h);
                switch (qa) {
                    case 2:
                    ...
                    case 4:
                        ...
                        k.open("POST", "http://localhost:8333", !1), k.onreadystatechange = function () {
                            ...
                            const tempPlaybackLog = localStorage.playbackLog ? JSON.parse(localStorage.playbackLog) : [];
                            const playbackLog = localStorage.playbackLog ? (tempPlaybackLog[0].logCount !== 0 ? tempPlaybackLog.slice(1) : tempPlaybackLog) : [];
                        var o = a - .15 - .4 - 4,
                            m = {
                                nextChunkSize: d(b + 1),
                                lastquality: e,
                                ...
                                lastChunkSize: c(h),
                                playbackLog
                                // timeStamp: localStorage.timeStamp ? JSON.parse(localStorage.timeStamp) : localStorage.timeStamp,
                                // frameRate: localStorage.fps ? JSON.parse(localStorage.fps) : localStorage.fps,
                                // timeFrame: localStorage.timeElapsed ? JSON.parse(localStorage.timeElapsed) : localStorage.timeElapsed,
                                // droppedFrames: localStorage.droppedFrames ? JSON.parse(localStorage.droppedFrames) : localStorage.droppedFrames,
                                // totalFrames: localStorage.totalFrames ? JSON.parse(localStorage.totalFrames) : localStorage.totalFrames
                            };
                            localStorage.playbackLog && localStorage.setItem("playbackLog", JSON.stringify([JSON.parse(localStorage.playbackLog)[JSON.parse(localStorage.playbackLog).length-1]]));
            ...
            function U(a, b) {
                var e = arguments.length <= 2 || void 0 === arguments[2] ? 0 : arguments[2],
                    f = arguments.length <= 3 || void 0 === arguments[3] ? 0 : arguments[3],
                    h = a.getType(),
                    i = a.getStreamInfo(),
                    j = i.id,
                    k = function (a) {
                ...
                if (N(h)) {
                    ...
                    Ja.applyRules(n, a, k, fa(h, i), function (a, b) {
                        if (a = a === g.default.NO_CHANGE ? 0 : a, 0 == qa) {
                            var h = _a.getReadOnlyMetricsFor("video"),
                                i = $a.getCurrentHttpRequest(h),
                                j = l(za, Aa, i),
                                k = new XMLHttpRequest;
                            k.open("POST", "http://localhost:8333", !1), k.onreadystatechange = function () {
                                4 == k.readyState && 200 == k.status && (console.log("GOT RESPONSE:" + k.responseText + "---"), "REFRESH" == k.responseText && document.location.reload(!0))
            ...
            function ma(a, b) {
                ...
                var c = Wa && window.hasOwnProperty("devicePixelRatio"),
                    d = c ? window.devicePixelRatio : 1,
                    e = Za.getElement(),
                    f = e.clientWidth * d,
                    g = e.clientHeight * d,
                    h = Xa.getValue(),
                    i = Ya.getAdaptationForType(h, 0, b).Representation,
                    j = a;
                if (f > 0 && g > 0) {
            ...
            function na(a) {
                ...
                if (N(b)) {
                    var c = function () {
                        var c = Ia.getRules(m.default.ABANDON_FRAGMENT_RULES),
                            d = Sa[b].getScheduleController();
                        if (!d) return {
                            v: void 0
                        };
                        var e = function (c) {
                            if (c.confidence === g.default.STRONG && c.value < fa(b, Ka.getActiveStreamInfo())) {
                                var e = d.getFragmentModel(),
                                    f = e.getRequests({
            ...
            var oa = this.context,
                pa = (0, s.default)(oa).getInstance(),
                qa = -1,
                ra = [300, 750, 1200, 1850, 2850, 4300],
                sa = 5,
                ta = 10,
                ua = 1,
                va = [],
    ...
    61: [function (a, b, c) {
        ...
        function e() {
            ...
            var h = void 0,
                j = this.context,
                l = (0, q.default)(j).getInstance(),
                n = (0, k.default)(j).getInstance(),
                o = void 0,
                p = void 0;
            return h = {
                reset: e,
    ...
    63: [function (a, b, c) {
        ...
        function e(a) {
            ...
            function h(a, b) {
                ...
                c ? l(c) : fa.trigger(u.default.INIT_REQUESTED, {
                    sender: qa
                })
            }
            ...
            function j(a) {
                if (a.fragmentModel === Ia.getFragmentModel()) {
                    var b = a.chunk,
                        c = b.bytes,
                        d = b.quality,
                        e = Ia.getRepresentationInfoForQuality(d),
                        f = ha.getValue(),
                        h = ma.getEventsFor(f, e.mediaInfo, Ia),
                        i = ma.getEventsFor(f, e, Ia);
            ...
            function n(a) {
                if (za === a.buffer) {
                    ...
                    if (b && b.length > 0)
                        for (var c = 0, d = b.length; c < d; c++) ea("Buffered Range for type:", ya, ":", b.start(c), " - ", b.end(c));
            ...
            function z() {
                if (ta < F && !sa) pa == -1 && (pa = Date.now()), B(E);
                else {
                    var a = 0;
            ...
            function B(a) {
                Aa === a || "fragmentedText" === ya && na.getAllTracksAreDisabled() || (Aa = a, x(), fa.trigger(u.default.BUFFER_LEVEL_STATE_CHANGED, {
                    ...
                    mediaType: ya,
                    streamInfo: Ia.getStreamInfo()
                }), fa.trigger(a === D ? u.default.BUFFER_LOADED : u.default.BUFFER_EMPTY, {
                    mediaType: ya
                }), ea(a === D ? "Got enough buffer to start." : "Waiting for more buffer before starting playback."))
            }
            ...
            function J() {
                if ("fragmentedText" !== ya) {
                    var a = za.buffered.length ? za.buffered.start(0) : 0,
                        b = Ha.getTime() - a - La.getBufferToKeep();
            ...
            function K() {
                if (!za) return null;
                var a = Ha.getTime(),
                    b = Ia.getFragmentModel().getRequests({
                        state: g.default.FRAGMENT_MODEL_EXECUTED,
                        time: a
                    })[0],
                    c = ia.getBufferRange(za, a),
            ...
            var da = this.context,
                ea = (0, A.default)(da).getInstance().log,
                fa = (0, s.default)(da).getInstance(),
                ga = a.metricsModel,
                ha = a.manifestModel,
                ia = a.sourceBufferController,
                ja = a.errHandler,
                ka = a.streamController,
                la = a.mediaController,
                ma = a.adapter,
                na = a.textSourceBuffer,
                oa = 0,
                pa = -1,
                qa = void 0,
                ra = void 0,
    ...
    65: [function (a, b, c) {
        ...
        function e() {
            ...
            function c(a) {
                var b = r[a];
                return b || (b = (0, j.default)(k).create({
                    metricsModel: (0, l.default)(k).getInstance()
                }), r[a] = b), b
            }
            ...
            var k = this.context,
                m = (0, t.default)(k).getInstance().log,
                o = (0, n.default)(k).getInstance(),
                q = void 0,
                r = void 0;
            return q = {
                process: b,
                getModel: c,
                isInitializationRequest: d,
                reset: e
            }, a(), q
        }
        Object.defineProperty(c, "__esModule", {
    ...
    68: [function (a, b, c) {
        ...
        function e() {
            ...
            function C(a) {
                var b = void 0,
                    c = (0, i.default)(_).getInstance().getURIFragmentData(),
                    d = parseInt(c.s, 10),
                    e = parseInt(c.t, 10),
                    f = NaN;
                if (a || (f = isNaN(d) ? e : d), ra) !isNaN(f) && f > 1262304e3 && (b = f - qa.manifestInfo.availableFrom.getTime() / 1e3, (b > na || b < na - qa.manifestInfo.DVRWindowSize) && (b = null)), b = b || na;
                else if (!isNaN(f) && f < Math.max(qa.manifestInfo.duration, qa.duration) && f >= 0) b = f;
                else {
                    var g = pa[qa.id];
            ...
            function I(a) {
                if (!a.error) {
                    var b = ka.convertDataToTrack(ia.getValue(), a.currentRepresentation),
            ...
            function L() {
                aa("Native video element event: play"), H(), E(), ba.trigger(o.default.PLAYBACK_STARTED, {
                    startTime: r()
                })
            }

            function M() {
                aa("Native video element event: playing"), ba.trigger(o.default.PLAYBACK_PLAYING, {
                    playingTime: r()
                })
            }

            function N() {
                aa("Native video element event: pause"), ba.trigger(o.default.PLAYBACK_PAUSED, {
                    ended: v()
                })
            }
            ...
            function O() {
                var a = r();
                aa("Seeking to: " + a), E(), ba.trigger(o.default.PLAYBACK_SEEKING, {
                    seekTime: a
                })
            }
            ...
            function Q() {
                var a = r();
                a !== ma && (ma = a, ba.trigger(o.default.PLAYBACK_TIME_UPDATED, {
                    timeToEnd: d(),
                    time: a
                }))
            }
            ...
            function S() {
                var a = t();
                aa("Native video element event: ratechange: ", a), ba.trigger(o.default.PLAYBACK_RATE_CHANGED, {
                    playbackRate: a
                })
            }
            ...
            function V(a) {
                ...
                ba.trigger(o.default.PLAYBACK_ERROR, {
                    error: b.error
                })
            }

            function W() {
                ba.trigger(o.default.WALLCLOCK_TIME_UPDATED, {
                    isDynamic: ra,
                    time: new Date
                })
            }
            ...
            function X(a) {
                ...
                if (b && b.length) {
                    var c = Math.max(b.start(0), qa.start),
                        d = void 0 === pa[qa.id] ? c : Math.max(pa[qa.id], c);
            ...
            var _ = this.context,
                aa = (0, s.default)(_).getInstance().log,
                ba = (0, m.default)(_).getInstance(),
                ca = void 0,
                da = void 0,
                ea = void 0,
                fa = void 0,
        ...
        function e(a) {
            ...
            function g() {
                if (!(xa || Ba || !Ma || Fa.isPaused() && !Pa)) {
                    i();
                    var a = Sa.length > 0,
                        b = Na.execute(Ia, ra, Ja.isVideoTrackPresent());
                    if (b || a) {
                        var c = function () {
                            if (va.quality !== Ra) Ra = va.quality, Ma.switchInitData(Ia.getStreamInfo().id, va.quality);
                            else {
            ...
            function V(a) {
                if (!a.error) {
                    var b = va.mediaInfo.streamInfo.manifestInfo.DVRWindowSize / 2,
                        ...
                        e = ma.getCurrentManifestUpdate(ja.getMetricsFor("stream")),
                        f = Fa.getLiveStartTime(),
                        g = la.getFragmentRequestForTime(Ia, va, c, {
                            ignoreIsFinished: !0
                        });
            ...
            var ga = this.context,
                ha = (0, P.default)(ga).getInstance().log,
                ia = (0, H.default)(ga).getInstance(),
                ja = a.metricsModel,
                ka = a.manifestModel,
                la = a.adapter,
                ma = a.dashMetrics,
                na = a.dashManifestModel,
                oa = a.timelineConverter,
    ...
    71: [function (a, b, c) {
        ...
        function e() {
            ...
            function v() {
                var a = na.getStreamInfo().start,
                    b = na.getStreamInfo().duration;
            ...
            function w(a) {
                ...
                for (var e = 0; e < d; e++)
                    if (c = ma[e], b += c.getDuration(), a < b) return c;
                return null
            }
            ...
            function F() {
                var a, b, c, d, f, g, h, j = aa.getValue(),
                    k = da.getMetricsFor("stream"),
                    l = ea.getCurrentManifestUpdate(k),
                    m = [];
                if (j) {
    ...
    104: [function (a, b, c) {
        ...
        function e() {
            ...
            function q() {
                var a = "webkitDroppedFrameCount" in s,
                    b = "getVideoPlaybackQuality" in s,
                    c = null;
        ...
        function e(a) {
            ...
            function v(a) {
                ...
                if (f)
                    ...
                    } else f.laURL && "" !== f.laURL && (n = f.laURL);
                else n = L.getLicenseServerURLFromInitData(g.default.getPSSHData(e.initData)), n || (n = a.data.laURL);
    ...
    128: [function (a, b, c) {
        ...
        function e(a) {
            ...
            var h = void 0,
                i = a.streamProcessor.getCurrentRepresentationInfo(),
                j = a.streamProcessor,
                k = a.currentValue;
            return h = {
                getStreamInfo: b,
    ...
    131: [function (a, b, c) {
        ...
        function e() {
            function a() {
                e = [], f = [];
                var a = (0, w.default)(c).getInstance(),
                    b = (0, y.default)(c).getInstance(),
                ...
                d.getBufferOccupancyABREnabled() ? (e.push((0, q.default)(c).create({
                    ...
                    metricsModel: a,
                    dashMetrics: b
                })), e.push((0, m.default)(c).create({
                    metricsModel: a
                })), f.push((0, o.default)(c).create()))
            }
    ...
    132: [function (a, b, c) {
        ...
        function e() {
            ...
            function d(a, d) {
                var f = a.getMediaInfo(),
                    i = f.type,
                    m = a.getCurrentValue().request,
                    s = (0, g.default)(l).create(g.default.NO_CHANGE, g.default.WEAK, {
                ...
                if (!isNaN(m.index)) {
                    ...
                    if (void 0 === t.firstByteTime && (q[i] = [], t.firstByteTime = m.firstByteDate.getTime(), t.segmentDuration = m.duration, t.bytesTotal = m.bytesTotal, t.id = m.index), t.bytesLoaded = m.bytesLoaded, t.elapsedTime = (new Date).getTime() - t.firstByteTime, t.bytesLoaded > 0 && t.elapsedTime > 0 && c(i, Math.round(8 * t.bytesLoaded / t.elapsedTime)), q[i].length >= k && t.elapsedTime > j && t.bytesLoaded < t.bytesTotal) {
                        ...
                        if (!p.hasOwnProperty(t.id)) {
                            var v = a.getStreamProcessor().getABRController(),
                                w = t.bytesTotal - t.bytesLoaded,
    ...
    133: [function (a, b, c) {
        ...
        function e(a) {
            ...
            function f(a, b) {
                var f = a.getMediaInfo(),
                    h = f.type,
                    i = q.getReadOnlyMetricsFor(h),
                    m = a.getCurrentValue(),
                    r = m.request,
                    t = (0, g.default)(l).create(g.default.NO_CHANGE, g.default.WEAK, {
                        name: e.__dashjs_factory_name
                    });
                if (0 === i.BolaState.length) return n("WARNING: executing BolaAbandonRule before initializing BolaRule"), s[h] = null, void b(t);
                var u = i.BolaState[0]._s,
                    v = r.index,
                    w = r.quality;
                if (isNaN(v) || 0 === w || !d(h, v, w) || !r.firstByteDate) return void b(t);
                var x = Date.now(),
                    y = x - r.firstByteDate.getTime(),
                    z = r.bytesLoaded,
                    A = r.bytesTotal,
                    B = A - z,
                    C = r.duration,
                    D = p.getCurrentBufferLevel(i) ? p.getCurrentBufferLevel(i) : 0,
                    E = D + u.virtualBuffer,
                    F = 8 * z / (.001 * y),
                    G = u.bandwidthSafetyFactor * F,
                ...
                var K = A * u.bitrates[0] / u.bitrates[w],
                    L = B - H * G / 8;
                ...
                if (u.state === o.default.BOLA_STATE_STARTUP) {
                    ...
                    for (var Q = (u.Vp * (u.utilities[w] + u.gp) - M) / L, P = 0; P <= N; ++P) {
    ...
    134: [function (a, b, c) {
        ...
        function e(a) {
            ...
            function D(a, b) {
                ...
                var d = (0, g.default)(H).create(g.default.NO_CHANGE, g.default.WEAK, {
                        name: e.__dashjs_factory_name
                    }),
                    i = a.getMediaInfo(),
                    k = i.type,
                    m = K.getReadOnlyMetricsFor(k);
                ...
                var u = J.getCurrentBufferLevel(m) ? J.getCurrentBufferLevel(m) : 0,
                    v = j(m, r.throughputCount, k);
                u <= .1 && (r.virtualBuffer = 0);
                var A = o(m, k);
                A > 0 && (r.virtualBuffer += A), r.virtualBuffer < 0 && (r.virtualBuffer = 0);
                var B = u + r.virtualBuffer,
                    D = h(r, B);
                ...
                if (v > 0)
                    for (var L = C * v * u / r.fragmentDuration; D > 0 && s[D] > L;) --D;
                var M = 0,
                    N = r.Vp * (t[D] + r.gp);
            ...
            var F = 2,
                G = 3,
                H = this.context,
                I = (0, v.default)(H).getInstance().log,
                J = a.dashMetrics,
                K = a.metricsModel,
                L = (0, r.default)(H).getInstance(),
                M = void 0,
                N = void 0,
                O = void 0,
                P = void 0,
        ...
        function e(a) {
            ...
            function c(a, b) {
                var c = (new Date).getTime() / 1e3,
                    ...
                    f = a.getTrackInfo(),
                    i = d.type,
                    o = isNaN(f.fragmentDuration) ? 2 : f.fragmentDuration / 2,
                    q = a.getCurrentValue(),
                    r = a.getStreamProcessor(),
                    s = r.getABRController(),
                    t = l.getReadOnlyMetricsFor(i),
                    u = m.getCurrentBufferLevel(t),
                    v = t.BufferState.length > 0 ? t.BufferState[t.BufferState.length - 1] : null,
                    w = !1,
                    x = d.representationCount - 1,
                    y = (0, g.default)(h).create(g.default.NO_CHANGE, g.default.WEAK, {
                        name: e.__dashjs_factory_name
                    });
    ...
    136: [function (a, b, c) {
        ...
        function e(a) {
            ...
            var j = this.context,
                l = (0, q.default)(j).getInstance().log,
                n = (0, k.default)(j).getInstance(),
                o = a.metricsModel,
                p = void 0,
                r = void 0,
    ...
    137: [function (a, b, c) {
        ...
        function e(a) {
            ...
            function c(a, b) {
                for (var c = (0, g.default)(h).create(1e6, g.default.WEAK, {
                        name: e.__dashjs_factory_name
                    }), d = k.getHttpRequests(j.getReadOnlyMetricsFor("video")), f = [], i = [], m = 0; m < d.length; m++) {
                    var n = d[m];
                ...
                console.log("NUMBER OF COMPLETE: " + f.length + " AT " + Date.now()), f.length <= l ? c = (0, g.default)(h).create(g.default.NO_CHANGE, g.default.WEAK, {
                    name: e.__dashjs_factory_name
                }) : l = f.length, b(c)
            }
            ...
            var f = void 0,
                h = this.context,
                j = ((0, n.default)(h).getInstance().log, a.metricsModel),
                k = a.dashMetrics,
                l = 0,
                m = void 0,
                p = void 0;
    ...
    138: [function (a, b, c) {
        ...
        function e(a) {
            ...
            function d(a, b) {
                var c = Math.min(z[a].length, b ? o : p),
                    d = z[a].slice(c * -1, z[a].length);
            ...
            var l = 20,
                ...
                u = 1.3,
                v = this.context,
                w = (0, r.default)(v).getInstance().log,
                x = a.dashMetrics,
                y = a.metricsModel,
                z = void 0,
                A = void 0,
    ...
    143: [function (a, b, c) {
        ...
        function e(a) {
            ...
            function c(a, b) {
                ...
                }, t = Math.floor((d.end - d.start) / 2), c = o.getFragmentRequestForTime(A, u, r, {
                    ignoreIsFinished: !0
                }), e(r, h, f, c)
            }
            ...
            function e(a, b, c, d) {
                var f;
                if (null === d) f = o.generateFragmentRequestForTime(A, u, a), e(a, b, c, f);
                else {
                    var g = function d(e) {
            ...
            function f(a, b) {
                var c, d, i;
                return v ? void j(!1, b) : (i = b - r, c = i > 0 ? r - i : r + Math.abs(i) + t, void(c < s.start && c > s.end ? y((0, g.default)(l).create(null, x)) : (d = o.getFragmentRequestForTime(A, u, c, {
                    ignoreIsFinished: !0
                }), e(c, h, f, d))))
            }
            ...
            function h(a, b) {
                ...
                if (!v) {
                    ...
                    if (v = !0, s.end = f + 2 * t, b === r) return d = b + w, c = o.getFragmentRequestForTime(A, u, d, {
                        ignoreIsFinished: !0
                    }), void e(d, function () {
                        j(!0, d)
                    }, function () {
            ...
            function j(a, b) {
                var c, d, i;
                a ? s.start = b : s.end = b, c = Math.floor(s.end - s.start) <= w, c ? y((0, g.default)(l).create(a ? b : b - w, x)) : (i = (s.start + s.end) / 2, d = o.getFragmentRequestForTime(A, u, i, {
                    ignoreIsFinished: !0
                }), e(i, h, f, d))
            }
            var l = this.context,
                m = (0, i.default)(l).getInstance(),
                o = a.adapter,
                p = a.timelineConverter,
                q = void 0,
                r = void 0,
    ...
    145: [function (a, b, c) {
        ...
        function e() {
            function a() {
                e = [], f = [], e.push((0, m.default)(c).create({
    ...
    146: [function (a, b, c) {
        ...
        function e() {
            function a() {
                ...
                }), n = (0, q.default)(e).create({
                    blacklistController: l
                }), p = (0, o.default)(e).create({
                    blacklistController: l
                }), r = n
            }
            ...
            function c(a) {
                ...
                var d = r.select(b);
                return d ? (a.selectedIdx = b.indexOf(d), d) : void f.trigger(i.default.URL_RESOLUTION_FAILED, {
                    error: new Error(t, u)
                })
            }
            ...
            var e = this.context,
                f = (0, g.default)(e).getInstance(),
                h = (0, k.default)(e).getInstance(),
                j = void 0,
                l = void 0,
                n = void 0,
                p = void 0,
            ...
            function i(a) {
                ...
                switch (h(a, d, l), a.hasOwnProperty("_incomplete") && (d.isComplete = !a._incomplete), d.type) {
                    ...
                    case "tfdt":
                        ...
                        break;
                    case "trun":
                        if (h(a, d, t), d.samples)
                            for (b = 0, c = d.samples.length; b < c; b++) h(a.samples[b], d.samples[b], u)
                }
                return d
            }
            var j = void 0,
    ...
    158: [function (a, b, c) {
        ...
        function e() {
            ...
            function j(a, e, f) {
                ...
                var w = E(),
                    x = ba.getElement().clientWidth,
                    y = ba.getElement().clientHeight,
                    z = [x / w[0], y / w[1]];
                V["font-size"] = z[1] + "px;";
                var D = [];
                if (Q)
                    for (var J = 0; J < Q.length; J++) D.push(B(JSON.parse(JSON.stringify(Q[J])), z));
                ...
                for (var M = [], N = j.body_asArray[0].__children, U = 0; U < N.length; U++) {
                    ...
                    if (null === (X = b(W))) {
                        ...
                        for (var Z = 0; Z < Y.length; Z++) {
                            ...
                            if (0 !== aa.length)
                                for (var da = $.__children, ea = 0; ea < aa.length; ea++) {
                        ...
                        if (void 0 !== W["smpte:backgroundImage"])
                            for (var wa = 0; wa < va.length; wa++) "#" + va[wa]["xml:id"] === W["smpte:backgroundImage"] && M.push({
                                start: X[0],
                                end: X[1],
                                id: c(),
            ...
            function x(a, b, c) {
                ...
                if ("line-height" in a)
                    if ("normal" === a["line-height"]) d.push("line-height: normal;");
                    else {
            ...
            var K = this.context,
                L = (0, k.default)(K).getInstance().log,
                M = void 0,
                N = void 0,
                O = void 0,
                P = void 0,
